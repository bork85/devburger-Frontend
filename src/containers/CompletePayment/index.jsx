...
const STATUS_CONTENT_MAP = {
    ...
    requires_payment_method: {
        text: "Erro no processamento do pagamento, tente novamente!",
        iconColor: "#DF1B41",
        icon: ErrorIcon,
    ...
    return (
        <div id='container'>
            <div id="payment-status">
                ...
                {intentId && <a href={`https://dashboard.stripe.com/payments/${intentId}`} id="view-details"
                    rel="noopener noreferrer" target="_blank">Detalhes
